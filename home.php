...
//adding number od unread mesgs
	...
	<input type="text" name="title" placeholder="Write a title" size="75" required="required"><br>
	<textarea cols="76" rows="5"  name="content" placeholder="Write description..."></textarea><br>
	<select name="topic">
		<option>Select Topic</option>
		<?php  getTopics(); ?>
	</select>
	<input type="submit" name="submitpost" value="Post to Timeline"> 
